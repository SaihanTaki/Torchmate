...
from torchmate.callbacks import CSVLogger
from torchmate.callbacks import EarlyStopper
from torchmate.callbacks import GradientAccumulator
from torchmate.callbacks import GradientClipper
from torchmate.callbacks import ModelCheckpoint
from torchmate.callbacks import WandbLogger
from torchmate.callbacks import WandbModelCheckpoint
...
def test_gradient_clipper_clip_by_value_on_backward_end(trainer):
    ...
    with torch.autocast(device_type=trainer.device,
