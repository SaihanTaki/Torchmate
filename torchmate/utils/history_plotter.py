...
class HistoryPlotter:
    ...
    Args:
        ...
        history (Dict, optional): A dictionary containing the training history data, with keys such as ``loss``, ``lr``, and other metric names.
    ...
    **Example usage:**
    ...
    def format_to_space_capitalized(text):
        """
        Converts a string to space-separated capitalized words, handling various formats.
    ...
    def plot_all(self):
        """
        Plots loss, learning rate and all available metrics.
        """
